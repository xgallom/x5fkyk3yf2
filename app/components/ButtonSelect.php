 ...
 */
class ButtonSelect extends ChoiceControl
{
    /** @var bool */
    ...
    public function __construct($label = null, array $items = null)
    {
        ...
        $this->container = Html::el('div class="btn-group btn-block" data-toggle="buttons"');
        $this->separator = Html::el();
        $this->itemLabel = Html::el('label class="btn btn-primary btn-block"');
    ...
    {
        return parent::setDefaultValue($value); // TODO: Change the autogenerated stub
    }
}
