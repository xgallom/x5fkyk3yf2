...
class RouterFactory
{
	...
	public static function createRouter()
	{
        ...
        $router[] = new Route('search/summary ? city_from=<cityFrom> & city_to=<cityTo> & trip_type=<tripType> & departure_0=<departure0> & travel_type_0=<travelType0> & travel_provider_0=<travelProvider0> & departure_1=<departure1> & travel_type_1=<travelType1> & travel_provider_1=<travelProvider1> & error=<error>', 'Search:summary');
